...
\
	...
	REGISTER_STRING_CONSTANT("PHP_COMPILER_ID", PHP_COMPILER_ID, CONST_CS | CONST_PERSISTENT);\
\
	/*	窗口属性 */\
 ...
 \
	...
	REGISTER_LONG_CONSTANT("IDABORT", IDABORT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("IDIGNORE", IDIGNORE, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("IDNO", IDNO, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("IDYES", IDYES, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("IDRETRY", IDRETRY, CONST_CS|CONST_PERSISTENT);\
...
\
	/* 窗口resize */\
	REGISTER_LONG_CONSTANT("WMSZ_LEFT", WMSZ_LEFT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_RIGHT", WMSZ_RIGHT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_TOP", WMSZ_TOP, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_TOPLEFT", WMSZ_TOPLEFT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_TOPRIGHT", WMSZ_TOPRIGHT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_BOTTOM", WMSZ_BOTTOM, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_BOTTOMLEFT", WMSZ_BOTTOMLEFT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("WMSZ_BOTTOMRIGHT", WMSZ_BOTTOMRIGHT, CONST_CS|CONST_PERSISTENT);\
\
	/* 窗口位置 */\
 ...
 \
	...
	REGISTER_LONG_CONSTANT("DHTML_ONBEFORENAVIGATE2", DLG_EVENT_ONBEFORENAVIGATE2, CONST_CS|CONST_PERSISTENT) ;\
	...
	REGISTER_LONG_CONSTANT("DHTML_ONWMUSER", DLG_EVENT_ONWMUSER, CONST_CS|CONST_PERSISTENT) ;\
	REGISTER_LONG_CONSTANT("DHTML_PRETRANSLATEMSG", DLG_EVENT_PRETRANSLATEMSG, CONST_CS|CONST_PERSISTENT) ;\
	REGISTER_LONG_CONSTANT("DHTML_WINDOWPROC", DLG_EVENT_WINDOWPROC, CONST_CS|CONST_PERSISTENT) ;\
 \
	/* 托盘图标事件 */\
...
\
	/* 进程常量 */\
	REGISTER_LONG_CONSTANT("STILL_ACTIVE", STILL_ACTIVE, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_ENUM_PROCS_ID", PDR_ENUM_PROCS_ID, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_ENUM_PROCS_FULLPATH", PDR_ENUM_PROCS_FULLPATH, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_ENUM_PROCS_FILENAME", PDR_ENUM_PROCS_FILENAME, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_ENUM_PROCS_CL", PDR_ENUM_PROCS_CL, CONST_CS|CONST_PERSISTENT);\
\
	/* 资源类型ID */\
	REGISTER_LONG_CONSTANT("RC_CURSOR", (ULONG_PTR)RT_CURSOR, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_BITMAP", (ULONG_PTR)RT_BITMAP, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_ICON", (ULONG_PTR)RT_ICON, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_MENU", (ULONG_PTR)RT_MENU, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_DIALOG", (ULONG_PTR)RT_DIALOG, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_STRING", (ULONG_PTR)RT_STRING, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_FONTDIR", (ULONG_PTR)RT_FONTDIR, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_FONT", (ULONG_PTR)RT_FONT, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_ACCELERATOR", (ULONG_PTR)RT_ACCELERATOR, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_RCDATA", (ULONG_PTR)RT_RCDATA, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_MESSAGETABLE", (ULONG_PTR)RT_MESSAGETABLE, CONST_CS|CONST_PERSISTENT);\
\
	REGISTER_LONG_CONSTANT("RC_GROUP_CURSOR", (ULONG_PTR)RT_GROUP_CURSOR, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_GROUP_ICON", (ULONG_PTR)RT_GROUP_ICON, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_VERSION", (ULONG_PTR)RT_VERSION, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_DLGINCLUDE", (ULONG_PTR)RT_DLGINCLUDE, CONST_CS|CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("RC_HTML", (ULONG_PTR)RT_HTML, CONST_CS|CONST_PERSISTENT);
