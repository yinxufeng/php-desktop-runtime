...
\
	REGISTER_STRING_CONSTANT("PDR_API_VER", "0.1.0.33", CONST_CS | CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_API_VER_INT32", (0)|(1<<5)|(0<<10), CONST_CS | CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_API_VER_INT32_FULL", (0)|(1<<5)|(0<<10)|(33<<17), CONST_CS | CONST_PERSISTENT);\
\
	/*	窗口属性 */\
