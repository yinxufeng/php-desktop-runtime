...
\
	REGISTER_STRING_CONSTANT("PDR_API_VER", "0.1.0.43", CONST_CS | CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_API_VER_INT32", ( 0 <<27)|( 1 <<22)|( 0 <<15), CONST_CS | CONST_PERSISTENT);\
	REGISTER_LONG_CONSTANT("PDR_API_VER_INT32_FULL", ( 0 <<27)|( 1 <<22)|( 0 <<15)|43, CONST_CS | CONST_PERSISTENT);\
\
	/*	窗口属性 */\
